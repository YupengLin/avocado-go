...
class DefaultConfig {
  ...
  static String appName = 'Avocado Goods';
  ...
  static String countryCodeDefault = 'US';
  static String dialCodeDefault = '+1';
  static String nameDefault = 'United States';
  ...
  static List onBoardingData = [
    {
      'title': 'Welcome to Avocado Goods',
